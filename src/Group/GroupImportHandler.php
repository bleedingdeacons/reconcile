    ...
    public function handleImport(): void
    {
        ...
        try {
            ...
            if (file_exists($tempFile) && !unlink($tempFile)) {
                \Reconcile\Plugin::logWarning('Reconcile Group Import: Failed to delete temp file: ' . $tempFile);
            }
        ...
        if (is_dir($tempDir) && !rmdir($tempDir)) {
            ...
            \Reconcile\Plugin::logDebug('Reconcile Group Import: Could not remove temp directory (may not be empty): ' . $tempDir);
        }
