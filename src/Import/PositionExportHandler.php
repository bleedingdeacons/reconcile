 ...
 *
 * Handles the admin-post endpoint for the position export.
 * Generates a CSV file and sends it as a download.
 */
class PositionExportHandler
{
    private PositionExporter $exporter;

    public function __construct(PositionExporter $exporter)
    {
    ...
    {
        add_action('admin_post_reconcile_position_export', [$this, 'handleExport']);
    }
